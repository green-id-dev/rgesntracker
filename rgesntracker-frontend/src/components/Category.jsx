...
const Category = ({ category, criteres, criteresResult, setCriteresResult, open, setOpenCategory, filters, sortFilter }) => {
    ...
    const handleOnChange = (id, value) => {
        ...
        let localAudit = JSON.parse(localStorage.getItem("audit"));
        if (localAudit) {
        ...
        {renderCriteres && (
          ...
          >
              {totalFilterCritere.map((critere, index) => (
                  <EvaluationQuestion key={index} id={critere.id} question={critere.critere} url={critere.url} onChange={handleOnChange} critereResult={criteresResult} />
