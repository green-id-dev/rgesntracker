  ...
  const postAudit = async () => {
    ...
    return (
        <div className="w-full flex flex-col"> 
            <SiteInformationForm url={url} setUrl={setUrl} siteName={siteName} setSiteName={setSiteName}></SiteInformationForm>
            <AuditorInformationForm name={nameAuditor} setName={setNameAuditor} siteName={siteNameAuditor} setSiteName={setSiteNameAuditor} selectedSort={selectedSort} setSelectedSort={setSelectedSort} email={email} setEmail={setEmail}></AuditorInformationForm>
