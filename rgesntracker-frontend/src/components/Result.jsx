...
import SommaireComponent from "./SommaireRapport";
        ...
        <div className="p-4 md:p-8 my-8 w-full" id="result">
            ...
            <div className="flex mt-10 flex-col">
                ...
                <div className="flex mt-4 flex-row">
                    ...
                    <a href={formatUrl(audit.url)} target="_blank" rel="noopener noreferrer" className="font-arial font-semibold text-lg underline ml-2">
                        {audit.url}
                    </a>
                ...
                <div className="flex flex-row">
                    ...
                    <a href='/home' className="font-arial font-semibold text-lg ml-1">{new Date().toLocaleDateString(audit.updatedat)}</a>
                </div>
               {
                audit.nameAuditor && (
               <div className="flex flex-row">
            ...
            <DashboardGauges approved={approved.length} rejected={rejected.length} notApplicable={notApplicable.length} maxValue={criteres.length} globalRate={global}></DashboardGauges>
