            ...
            <div className="flex flex-col w-full md:w-1/2 mt-8 md:mt-0">
                ...
                <div className="flex flex-col md:flex-row gap-8 mt-8">
                    <div className="flex flex-col gap-4">
                        ...
                        <div
                            className={"border-2 border-bg-grey rounded-xl " + (isFinish ? "hover:cursor-pointer bg-[#90D8B2] hover:bg-[#00BF7D] " : "bg-greyBg")}
                            onClick={validate}>
                            <h1 className={"font-arial text-lg px-8 text-black z-10 py-4 font-bold text-center " + (isFinish ? " opacity-100" : "opacity-25")}>Valider
                                l'audit</h1>
                        </div>
                    </div>
